...
(function() {
    var d = document,
        ...
        iopa = ua.indexOf('opera') != -1 && opera.version(),
        iie = (ua.indexOf('msie') != -1 && !iopa) && ua.substr(ua.indexOf('msie') + 5, 3),
        conf = (typeof(uyan_config) == 'undefined') ? {} : uyan_config,
        s = d.getElementsByTagName('script');
    for (var i = 0, ss; ss = s[i++];) {
    ...
    try {
        if (typeof(w.uyan_loaded) == 'undefined') {
            w.UYAN = {
                apiHost: 'http://jsapi.uyan.cc/',
                imgHost: 'http://v2.uyan.cc/code/images/',
                tmpS: '',
                sort: '',
                ct: '',
                msgS: true,
                ...
                creFrm: function(t, w, h) {
                    if (conf.inifr != true) {
                        UYAN.showBox();
                        var a = d.createElement('iframe'),
                            bc = d.getElementById('uyan_box_cnt')
                    }
                ...
                reqItf: function(v, t) {
                    try {
                        var A = d.getElementById('uyan_script'),
                            B = "http://api.uyan.cc/";
                ...
                yTo: function(y) {
                    ...
                    g = setInterval(function() {
                        if (y != null) {
                            ...
                            if (UYAN.getY() <= 24="" 60="" 0)="" {="" clearinterval(g)="" }="" },="" 1);="" settimeout(function()="" 3000)="" getevent:="" function(e)="" var="" a="window.event" ||="" e="" null,="" c,="" ct="0;" if="" (!a)="" c="arguments.callee;" while="" (c="" &&="" <="" 10)="" ((a="c.arguments[0])" (typeof(a.button)="" !="undefined" typeof(a.ctrlkey)="" ))="" break="" }++ct;="" return="" getmp:="" function()="" array();="" c.x="a.clientX;" c.y="a.clientY;" setcookie:="" function(n,="" v,="" e,="" p,="" d,="" s)="" date="new" date();="" ?="" :="" (e="" *="" 1000);="" date.settime(date.gettime()="" +="" a);="" b="n" '=" + escape(v);
                    b += (e) ? " ;="" expires=" + date.toGMTString() : " ';="" path=" + p : " domain=" + d : " secure'="" '';="" document.cookie="b" getcookie:="" function(n)="" s="d.cookie.indexOf(n" ;',="" l);="" ((!s)="" (n="" n.length)))="" (s="=" -1)="" unescape(d.cookie.substring(l,="" e))="" delcookie:="" uyan.setcookie(n,="" trim:="" function(s)="" s.replace(="" (^\s*)|(\s*$)="" g,="" '')="" getsu:="" loc="a.indexOf('#')," al="d.getElementsByTagName('link')," am="d.getElementsByTagName('meta')," p="/\?p=\d+$/," du="UYAN.getDu();" (loc="" loc);="" 2);="" for="" (var="" i="0;" al.length;="" i++)="" (al[i].rel="=" 'shortlink')="" (p.test(al[i].href))="" try="" (uyid="" uyid.content="=" null)="" catch="" (e)="" {}="" j="0;" am.length;="" j++)="" (am[j].name)="" (am[j].name="=" 'uyid'="" am[j].content)="" (du="" a.split(window.location.host)[1]="" getdu:="" getpic:="" pic="" (a.length=""> 0) {
                    ...
                    for (var i = 0; i < a.length; i++) {
                        if (a[i].getAttribute('uyan_identify') == 'true' || a[i].id == 'uyan_count_unit') {
                            UYAN.reqItf({
                                mode: 'count',
                                url: ec(a[i].href),
                                du: ec(a[i].getAttribute('du') != null ? a[i].getAttribute('du') : ''),
                                su: ec(a[i].getAttribute('su') != null ? a[i].getAttribute('su') : ''),
                                txt: ec(a[i].innerHTML)
                            }, 'count')
                        }
                ...
                init: function() {
                    var A = "?url=" + ec(String(conf.url || d.location)),
                        ...
                        J = "&lang=" + (params['lang'] ? params['lang'] : 'zh-cn'),
                        SRC = UYAN.apiHost + A + B + C + D + E + F + G + H + I + J;
                    if (params['style']) {
                ...
                voteCUD: function(a) {
                    var b = d.getElementById('uyan_vu'),
                        vd = d.getElementById('uyan_vd'),
                        vun = d.getElementById('uyan_vun'),
                        vl = d.getElementById('uyan_like'),
                        ss = UYAN.conf.style == 'facebook' ? '2' : '';
                ...
                cagStar: function(n) {
                    if (n == 0) {
                        ...
                        for (var i = 1; i < 6; i++) {
                            var a = d.getElementById('uyan_vs_' + i);
                            if (i <= 0="" 1="" 10="" 20="" n)="" {="" if="" (uyan.conf.style="" !="facebook" &&="" uyan.conf.style="" )="" a.style.background="url("" +="" uyan.imghost="" 'star_done.png")="" no-repeat="" scroll="" transparent'="" }="" else="" 'star_b_done.png")="" 'star_un.png")="" 'star_b_un.png")="" },="" cmtud:="" function(a,="" b)="" (a="=" 'uu'="" ||="" a="=" 'uc'="" 'du'="" 'dc')="" uyan.reqitf({="" mode:="" 'cud',="" type:="" a,="" cid:="" b="" })="" cmtcud:="" var="" c="d.getElementById('uyan_cu_'" b),="" cuw="d.getElementById('uyan_cuw_'" cd="d.getElementById('uyan_cd_'" cdw="d.getElementById('uyan_cdw_'" cun="p(c.innerHTML" =="" ?="" :="" c.innerhtml),="" cdn="p(cd.innerHTML" cd.innerhtml);="" 'uu')="" c.innerhtml="cun" 1;="" cuw.style.background="url("" 'updig2color.png")="" transparent';="" c.parentelement.onclick="function()" uyan.cmtud('uc',="" };="" cuw.onclick="function()" (cdw.style.background.indexof('downdig2color')="" cd.innerhtml="cdn" -="" 0;="" cdw.style.background="url("" 'downdig2.png")="" cd.parentelement.onclick="function()" uyan.cmtud('du',="" cdw.onclick="function()" 'uc')="" 'updig2.png")="" uyan.cmtud('uu',="" 'du')="" (cuw.style.background.indexof('updig2color')="" 'downdig2color.png")="" uyan.cmtud('dc',="" hidintro:="" function(e,="" a)="" sm="d.getElementById('uyan_smile'" '_'="" '')),="" ss="d.getElementById('uyan_ssmile'" ''));="" (e.style.width="=" '')="" (iie)="" e.style.width="b.oW" 'px'="" e.style.height="b.oH" (e.value="=" uyan.lang.iptcmt)="" e.value="" ;="" e.style.color="#272727" sm.style.display="" ss.style.display="none" e.focus()="" shointro:="" settimeout(function()="" b.style.display="none" 200)="" shosmile:="" t,="" ,="" cs="a" '',="" cs),="" ssd="d.getElementById('uyan_ssmile_df'" ssa="d.getElementById('uyan_ssmile_al'" ssl="d.getElementById('uyan_ssmile_list'" cs);="" (t="=" 'al')="" ssd.style.background="none repeat scroll 0 center transparent" ssd.style.color="" ssa.style.background="url("" 'smileb.gif")="" ssa.style.color="#fff" for="" (var="" i="1;" <="40;" i++)="" al\''="" ',="" '="" ');"="" style="cursor: pointer; display: block; margin: 4px auto 0;" title="' + UYAN.smile.al[(i - 1)] + '" src="' + UYAN.imgHost + 'smile/al/' + i + '.gif">'
                        } else {
                ...
                addCmt: function(e, a, b) {
                    if (UYAN.conf.login || UYAN.conf.style == 'color') {
                        var f = a != null ? '_' + a : '',
                            c = d.getElementById('uyan_comment' + f),
                            s = d.getElementById('uyan_sync' + f),
                            t = d.getElementById('uyan_tts' + f),
                            cu = d.getElementById('uyan_cmt_uname' + f),
                            lu = d.getElementById('uyan_l_uname' + f),
                            le = d.getElementById('uyan_l_email' + f),
                            ll = d.getElementById('uyan_l_ulink' + f),
                            send = {};
                        try {
                            if (UYAN.conf.isvis) {
                                ...
                                if (UYAN.conf.style == 'color' && le.value != '' && le.value != UYAN.lang.iptEmail) {
                                    if (le.value.match(/^[\w][\w+\.\_\-]*@\w+(\.\w+)*\.[A-z]{2,}$/g) === null) {
                            ...
                            try {
                                if (a != null) {
                                    send = {
                                        ...
                                        vs: UYAN.vStar,
                                        pic: ec(UYAN.getPic()),
                                        vid: ec(String(conf.vid ? conf.vid : '')),
                                        tag: ec(String(conf.tag ? conf.tag : '')),
                                        uname: ec(lu.value == UYAN.lang.iptUname ? '' : lu.value),
                                        email: ec(le.value == UYAN.lang.iptEmail ? '' : le.value),
                                        ulink: (ll.value == UYAN.lang.iptUlink ? '' : ll.value)
                                    };
                ...
                addCCmt: function(a, t) {
                    var b = d.getElementById('uyan_cmt_list'),
                        clw = d.getElementById('uyan_cmt_list_warn'),
                        c = d.getElementById('uyan_comment'),
                        ct = d.getElementById('uyan_tts'),
                        acn = d.getElementById('uyan_acn'),
                        mc = d.getElementById('uyan_more_cmt'),
                        cb = d.getElementById('uyan_cmt_btn');
                    a = UYAN.cSmile(a);
                    if (t == 'add') {
                        try {
                ...
                addCRpy: function(a, b, f, t) {
                    var g = d.getElementById('uyan_cmt_' + b),
                        n = d.createTextNode('uyan_tmp_txt'),
                        acn = d.getElementById('uyan_acn'),
                        cl = d.getElementById('uyan_cmt_list'),
                        c = d.getElementById('uyan_comment_' + b),
                        rt = d.getElementById('uyan_tts_' + b),
                        cb = d.getElementById('uyan_cmt_btn_' + b),
                        mr = d.getElementById('uyan_more_rpy_' + b);
                    a = UYAN.cSmile(a);
                    if (t == 'more') {
                ...
                addRpy: function(a, b) {
                    try {
                        var f = d.getElementById('uyan_cmt_' + a),
                            cu = d.getElementById('uyan_cmt_uname_' + a),
                            r = d.getElementById('uyan_rpy'),
                            ri = d.getElementById('uyan_rpy_' + a),
                            A = (b != null) ? '<div id="uyan_rpy_' + a + '" style="padding-top: 10px;">' : (UYAN.conf.style == 'side' ? '<div id="uyan_rpy_' + a + '" style="opacity: 0; padding-top: 10px;">' : '<div id="uyan_rpy_' + a + '" style="opacity: 0; padding-left: 60px; padding-top: 10px;">');
                        if (ri != null) {
                            f.removeChild(ri)
                        } else {
                ...
                optCCmt: function(a, b, t) {
                    ...
                    for (var i = 0; i < c.length; i++) {
                        if (t == 'delcmt' && c[i].getAttribute('uyanopt') == ('uyan_' + t + '_' + a)) {
                            ...
                            c[i].setAttribute('uyanopt', 'uyan_rsrcmt_' + a);
                            ...
                            c[i].setAttribute('uyanopt', 'uyan_delcmt_' + a);
                            var e = c[i];
                            e.style.color = '#3030ff';
                            setTimeout(function() {
                                e.style.color = '#303030'
                            ...
                            c[i].setAttribute('uyanopt', 'uyan_dopcmt_' + a);
                            var e = c[i];
                            e.style.color = '#3030ff';
                            setTimeout(function() {
                                e.style.color = '#303030'
                            ...
                            c[i].setAttribute('uyanopt', 'uyan_topcmt_' + a);
                            var e = c[i];
                            e.style.color = '#3030ff';
                            setTimeout(function() {
                                e.style.color = '#303030'
                ...
                showBox: function() {
                    var a = d.getElementById('uyan_box'),
                        nb = d.createElement('div');
                    nb.id = 'uyan_box';
                    ...
                    setTimeout(function() {
                        ...
                        a.style.top = (s.psH <= 0="" 100="" ?="" :="" s.psh)="" +="" 'px';="" if="" (sc.ow="" !="0)" a.style.width="(sc.oW" 20)="" a.style.visibility="" },="" 1)="" hidebox:="" function()="" {="" var="" a="d.getElementById('uyan_box')," bc="d.getElementById('uyan_box_cnt');" a.style.display="none" ;="" bc.innerhtml="" cmty:="" uyan.showbox();="" c="d.getElementById('uyan_cmty')," 'uyan_cmty_info');="" uyan.reqitf({="" mode:="" 'getcmty'="" })="" cmtyc:="" function(a)="" b="d.getElementById('uyan_cmty_info');" b.innerhtml="a" cmtsort:="" function(a,="" t)="" sn="d.getElementById('uyan_sort_name')," st="d.getElementById('uyan_sort_time')," sh="d.getElementById('uyan_sort_hot');" (a="" (t="" uyan.ct="t;" 'getcmt',="" sort:="" a,="" ct:="" t="" }="" else="" uyan.sort="a;" sn.innerhtml="UYAN.lang.hotSort;" st.style.background="" st.style.fontweight="" sh.style.background="url("" uyan.imghost="" 'currentsort.png")="" no-repeat="" scroll="" 8px="" transparent';="" sh.style.fontweight="bold" null)="" (b.style.display="=" '')="" b.style.display="none" try="" stq="d.getElementById('uyan_sort_tqq');" 'tsina')="" c.parentnode.style.borderbottom="2px solid #" uyan.conf.color;="" c.parentnode.style.fontweight="600" stq.parentnode.style.borderbottom="" stq.parentnode.style.fontweight="" sn.parentnode.style.borderbottom="" sn.parentnode.style.fontweight="" 'tqq')="" 'none'="" &&="" uyan.conf.style="=" 'color')="" catch="" (e)="" {}="" login:="" l="d.getElementById('uyan_login')," 'uyan_email').replace('uyan_uname_tmp',="" 'uyan_uname').replace('uyan_login_warn_tmp',="" 'uyan_login_warn')="" logout:="" 'logout',="" py:="" uyan.gety()="" logoutcu:="" u="UYAN.conf.ufrom" =="sso" uyan.conf.dslogout="" location.href,="" loc="u.indexOf('#');" (loc="" loc);="" '');="" window.location.href="u" syncen:="" d.getelementbyid('uyan_uname').value="d.getElementById('uyan_email').value.split('@')[0]" nnbg:="" function(t)="" 's')="" d.getelementbyid('uyan_uname').style.background="#f2f2f2" 'h')="" writelog:="" (!conf.do_not_track="" w.location.host="" typeof(_gnaytrack)="" )="" d.write('<script="" type="text/javascript" src="http://v3.jiathis.com/code/plugin.client.js" charset="utf-8">')
                    }
                },
                loginEmail: function() {
                    var a = d.getElementById('uyan_email').value,
                        uname = d.getElementById('uyan_uname').value,
                        c = d.getElementById('uyan_comment'),
                        warn = d.getElementById('uyan_login_warn');
                    if (a != '') {
                        if (a.match(/^[\w][\w+\.\_\-]*@\w+(\.\w+)*\.[A-z]{2,}$/g) === null) {
                            ...
                            if (uname != '') {
                                UYAN.reqItf({
                                    ...
                                    uname: uname,
                                    py: UYAN.getY(),
                                    cmt: (c.value != UYAN.lang.iptCmt ? c.value : '')
                                });
                                warn.innerHTML = ''
                            } else {
                ...
                loginCEmail: function() {
                    var u = UYAN.conf.lcb ? UYAN.conf.lcb : location.href,
                        loc = u.indexOf('#');
                ...
                checkTxt: function(e, a, b) {
                    var s = d.getElementById('uyan_tts' + (b != null ? '_' + b : '')),
                        cc = d.getElementById('uyan_cmt_cnt' + (b != null ? '_' + b : '')),
                        sc, ch, k = e.value.match(/[^\x00-\xff]/g),
                        f = Math.floor((a * 2 - e.value.length - (k && k.length || 0)) / 2);
                    if (f >= 0) {
                        s.innerHTML = f;
                        s.style.color = ''
                    } else {
                    ...
                    sc = UYAN.getWH(cc), ch = Math.max(UYAN.conf.style == 'side' || UYAN.conf.style == 'facebook' || UYAN.conf.style == 'color' ? 40 : 60, sc.oH + 18);
                ...
                changeUtname: function() {
                    var a = d.getElementById('uyan_utname_txt'),
                        ue = d.getElementById('uyan_utname_edit');
                    if (a.style.display == '') {
                ...
                setCUtname: function(n) {
                    var u = d.getElementById('uyan_utname'),
                        us = d.getElementById('uyan_utname_show');
                    u.value = n;
                    us.innerHTML = n;
                    UYAN.changeUtname()
                },
                changeFemail: function() {
                    var a = d.getElementById('uyan_femail_txt'),
                        ue = d.getElementById('uyan_femail_edit');
                    if (a.style.display == '') {
                        a.style.display = 'none';
                        ue.style.display = ''
                    } else {
                ...
                setCFemail: function(n) {
                    var u = d.getElementById('uyan_femail'),
                        us = d.getElementById('uyan_femail_show');
                    u.value = n;
                    us.innerHTML = n;
                    UYAN.changeFemail()
                },
                ...
                cSmile: function(c) {
                    var a, cnt = c;
                    for (var i = 1; i <= 40;="" i++)="" {="" a="new" regexp("([\\(\\[]"="" +="" uyan.smile.df[(i="" -="" 1)]="" "[\\]\\)])",="" "g");="" cnt="cnt.replace(a," '<img="" src="' + UYAN.imgHost + 'smile/df/' + i + '.png">');
                        a = new RegExp("([\\(\\[]al" + UYAN.smile.al[(i - 1)] + "[\\]\\)])", "g");
                        cnt = cnt.replace(a, '<img src="' + UYAN.imgHost + 'smile/al/' + i + '.gif">')
                    }
                    return cnt
                },
                addSmile: function(e, t, a) {
                    var c = d.getElementById('uyan_comment' + (a != null ? '_' + a : '')),
                        cc = d.getElementById('uyan_cmt_cnt' + (a != null ? '_' + a : '')),
                        ss = d.getElementById('uyan_ssmile' + (a != null ? '_' + a : ''));
                ...
                ctlWhole: function(t) {
                    var b = document.getElementById('uyan_whole'),
                        g = null;
                    g = setInterval(function() {
                        if (t == 'h') {
                            var a = p(b.style.right.replace('px', ''));
                            if (a <= -315)="" {="" b.style.right="-315px" ;="" clearinterval(g)="" }="" else="" -="" 30)="" +="" 'px'="" if="" (t="=" 's')="" var="" a="p(b.style.right.replace('px'," ''));="" (a="">= 0) {
                                b.style.right = '0px';
                                clearInterval(g)
                            } else {
                ...
                getItem: function(a, b, c, d) {
                    ...
                    var e = [];
                    for (var i = 0, k = o.length; i < k; i += 1) {
                ...
                scrollBox: {
                    ...
                    sliding: function(a) {
                        ...
                        var o = d.getElementById(UYAN.scrollBox.sid[a]),
                            item = UYAN.getItem(o, UYAN.scrollBox.tag[a], UYAN.scrollBox.itn[a]),
                            len = item.length,
                            cl = item[len - 1].cloneNode(true);
                        ...
                        cl.style.height = '0px';
                        o.insertBefore(cl, o.firstChild);
                        var i = 0,
                            at = 15,
                ...
                changeS: function(e, t, a) {
                    var b = d.getElementById('uyan_star_' + a),
                        er = d.getElementById('uyan_exp_rpy_' + a);
                    if (t == 'on') {
                        b.style.display = '';
                        try {
                            if (UYAN.conf.style == 'color') {
                ...
                showMsg: function(e, a, b, c) {
                    if (UYAN.msgS == true) {
                        UYAN.msgS = false;
                        var d = e.type == 'textarea' ? e.value : e.innerHTML,
                            ec = e.style.color,
                            es = e.style.fontSize;
                        if (e.type == 'textarea') {
                            e.value = a
                ...
                getOtStr: function(a, t) {
                    var b = '',
                        len = a.length;
                    if (UYAN.conf.issso) {
                        switch (t) {
                            case '1':
                                b += '<a onclick="UYAN.loginSso();" style="padding: 0; cursor: pointer; display: block; float: left; height: 24px; margin-bottom: 2px; margin-right: 5px; width: 57px; background: url(\'' + UYAN.conf.dsbtn + '\') no-repeat scroll 0 0 transparent;"></a>';
                                break;
                            case '2':
                                b += '<a onclick="UYAN.loginSso();" style="padding: 0; cursor: pointer; display: block; float: left; height: 24px; margin-bottom: 2px; margin-right: 3px; width: 25px; background: url(\'' + UYAN.conf.dsbtn + '\') no-repeat scroll 0 0 transparent;"></a>';
                                break;
                            case '3':
                                b += '<a onclick="UYAN.loginSso();" style="padding: 0; cursor: pointer; display: block; float: left; height: 23px; margin-bottom: 2px; margin-right: 3px; width: 59px; background: url(\'' + UYAN.conf.dsbtn + '\') no-repeat scroll 0 0 transparent;"></a>';
                                break;
                            default:
                                b += '';
                                break
                    ...
                    for (var i = 0; i < len; i++) {
                        switch (a.charAt(i)) {
                            case '0':
                                switch (t) {
                                    case '1':
                                        b += '<a onclick="UYAN.login();" style="padding: 0; cursor: pointer; display: block; float: left; height: 24px; margin-bottom: 2px; margin-right: 5px; width: 57px; background: url(\'' + UYAN.imgHost + 'aoybtn.png\') no-repeat scroll 0 0 transparent;"></a>';
                                        break;
                                    case '2':
                                        b += '<a onclick="UYAN.login();" style="padding: 0; cursor: pointer; display: block; float: left; height: 24px; margin-bottom: 2px; margin-right: 3px; width: 25px; background: url(\'' + UYAN.imgHost + 'aoysbtn.png\') no-repeat scroll 0 0 transparent;"></a>';
                                        break;
                                    case '3':
                                        b += '<a onclick="UYAN.login();" style="padding: 0; cursor: pointer; display: block; float: left; height: 23px; margin-bottom: 2px; margin-right: 3px; width: 59px; background: url(\'' + UYAN.imgHost + 'bbtn.png\') no-repeat scroll -549px 0 transparent;"></a>';
                                        break;
                                    default:
                                        b += '';
                                        break
                            ...
                            case '1':
                                switch (t) {
                                    case '1':
                                        b += '<a onclick="UYAN.loginTSina();" style="padding: 0; cursor: pointer; display: block; float: left; height: 24px; margin-bottom: 2px; margin-right: 5px; width: 57px; background: url(\'' + UYAN.imgHost + 'tsinabtn.png\') no-repeat scroll 0 0 transparent;"></a>';
                                        break;
                                    case '2':
                                        b += '<a onclick="UYAN.loginTSina();" style="padding: 0; cursor: pointer; display: block; float: left; height: 24px; margin-bottom: 2px; margin-right: 3px; width: 25px; background: url(\'' + UYAN.imgHost + 'tsinasbtn.png\') no-repeat scroll 0 0 transparent;"></a>';
                                        break;
                                    case '3':
                                        b += '<a onclick="UYAN.loginTSina();" style="padding: 0; cursor: pointer; display: block; float: left; height: 23px; margin-bottom: 2px; margin-right: 3px; width: 59px; background: url(\'' + UYAN.imgHost + 'bbtn.png\') no-repeat scroll -61px 0 transparent;"></a>';
                                        break;
                                    default:
                                        b += '';
                                        break
                            ...
                            case '2':
                                switch (t) {
                                    case '1':
                                        b += '<a onclick="UYAN.loginTQq();" style="padding: 0; cursor: pointer; display: block; float: left; height: 24px; margin-bottom: 2px; margin-right: 5px; width: 57px; background: url(\'' + UYAN.imgHost + 'tqqbtn.png\') no-repeat scroll 0 0 transparent;"></a>';
                                        break;
                                    case '2':
                                        b += '<a onclick="UYAN.loginTQq();" style="padding: 0; cursor: pointer; display: block; float: left; height: 24px; margin-bottom: 2px; margin-right: 3px; width: 25px; background: url(\'' + UYAN.imgHost + 'tqqsbtn.png\') no-repeat scroll 0 0 transparent;"></a>';
                                        break;
                                    case '3':
                                        b += '<a onclick="UYAN.loginTQq();" style="padding: 0; cursor: pointer; display: block; float: left; height: 23px; margin-bottom: 2px; margin-right: 3px; width: 59px; background: url(\'' + UYAN.imgHost + 'bbtn.png\') no-repeat scroll -122px 0 transparent;"></a>';
                                        break;
                                    default:
                                        b += '';
                                        break
                            ...
                            case '3':
                                switch (t) {
                                    case '1':
                                        b += '<a onclick="UYAN.loginRenren();" style="padding: 0; cursor: pointer; display: block; float: left; height: 24px; margin-bottom: 2px; margin-right: 5px; width: 68px; background: url(\'' + UYAN.imgHost + 'renrenbtn.png\') no-repeat scroll 0 0 transparent;"></a>';
                                        break;
                                    case '2':
                                        b += '<a onclick="UYAN.loginRenren();" style="padding: 0; cursor: pointer; display: block; float: left; height: 24px; margin-bottom: 2px; margin-right: 3px; width: 29px; background: url(\'' + UYAN.imgHost + 'renrensbtn.png\') no-repeat scroll 0 0 transparent;"></a>';
                                        break;
                                    case '3':
                                        b += '<a onclick="UYAN.loginRenren();" style="padding: 0; cursor: pointer; display: block; float: left; height: 23px; margin-bottom: 2px; margin-right: 3px; width: 59px; background: url(\'' + UYAN.imgHost + 'bbtn.png\') no-repeat scroll -244px 0 transparent;"></a>';
                                        break;
                                    default:
                                        b += '';
                                        break
                            ...
                            case '4':
                                switch (t) {
                                    case '1':
                                        b += '<a onclick="UYAN.loginQq();" style="padding: 0; cursor: pointer; display: block; float: left; height: 24px; margin-bottom: 2px; margin-right: 5px; width: 70px; background: url(\'' + UYAN.imgHost + 'qqbtn.png\') no-repeat scroll 0 0 transparent;"></a>';
                                        break;
                                    case '2':
                                        b += '<a onclick="UYAN.loginQq();" style="padding: 0; cursor: pointer; display: block; float: left; height: 24px; margin-bottom: 2px; margin-right: 3px; width: 25px; background: url(\'' + UYAN.imgHost + 'qqsbtn.png\') no-repeat scroll 0 0 transparent;"></a>';
                                        break;
                                    case '3':
                                        b += '<a onclick="UYAN.loginQq();" style="padding: 0; cursor: pointer; display: block; float: left; height: 23px; margin-bottom: 2px; margin-right: 3px; width: 59px; background: url(\'' + UYAN.imgHost + 'bbtn.png\') no-repeat scroll 0 0 transparent;"></a>';
                                        break;
                                    default:
                                        b += '';
                                        break
                            ...
                            case '5':
                                switch (t) {
                                    case '1':
                                        b += '<a onclick="UYAN.loginT163();" style="padding: 0; cursor: pointer; display: block; float: left; height: 24px; margin-bottom: 2px; margin-right: 5px; width: 57px; background: url(\'' + UYAN.imgHost + 't163btn.png\') no-repeat scroll 0 0 transparent;"></a>';
                                        break;
                                    case '2':
                                        b += '<a onclick="UYAN.loginT163();" style="padding: 0; cursor: pointer; display: block; float: left; height: 24px; margin-bottom: 2px; margin-right: 3px; width: 25px; background: url(\'' + UYAN.imgHost + 't163sbtn.png\') no-repeat scroll 0 0 transparent;"></a>';
                                        break;
                                    case '3':
                                        b += '<a onclick="UYAN.loginT163();" style="padding: 0; cursor: pointer; display: block; float: left; height: 23px; margin-bottom: 2px; margin-right: 3px; width: 59px; background: url(\'' + UYAN.imgHost + 'bbtn.png\') no-repeat scroll -488px 0 transparent;"></a>';
                                        break;
                                    default:
                                        b += '';
                                        break
                            ...
                            case '6':
                                switch (t) {
                                    case '1':
                                        b += '<a onclick="UYAN.loginTSohu();" style="padding: 0; cursor: pointer; display: block; float: left; height: 24px; margin-bottom: 2px; margin-right: 5px; width: 57px; background: url(\'' + UYAN.imgHost + 'tsohubtn.png\') no-repeat scroll 0 0 transparent;"></a>';
                                        break;
                                    case '2':
                                        b += '<a onclick="UYAN.loginTSohu();" style="padding: 0; cursor: pointer; display: block; float: left; height: 24px; margin-bottom: 2px; margin-right: 3px; width: 25px; background: url(\'' + UYAN.imgHost + 'tsohusbtn.png\') no-repeat scroll 0 0 transparent;"></a>';
                                        break;
                                    case '3':
                                        b += '<a onclick="UYAN.loginTSohu();" style="padding: 0; cursor: pointer; display: block; float: left; height: 23px; margin-bottom: 2px; margin-right: 3px; width: 59px; background: url(\'' + UYAN.imgHost + 'bbtn.png\') no-repeat scroll -427px 0 transparent;"></a>';
                                        break;
                                    default:
                                        b += '';
                                        break
                            ...
                            case '7':
                                switch (t) {
                                    case '1':
                                        b += '<a onclick="UYAN.loginKaixin001();" style="padding: 0; cursor: pointer; display: block; float: left; height: 24px; margin-bottom: 2px; margin-right: 5px; width: 57px; background: url(\'' + UYAN.imgHost + 'kaixin001btn.png\') no-repeat scroll 0 0 transparent;"></a>';
                                        break;
                                    case '2':
                                        b += '<a onclick="UYAN.loginKaixin001();" style="padding: 0; cursor: pointer; display: block; float: left; height: 24px; margin-bottom: 2px; margin-right: 3px; width: 25px; background: url(\'' + UYAN.imgHost + 'kaixin001sbtn.png\') no-repeat scroll 0 0 transparent;"></a>';
                                        break;
                                    case '3':
                                        b += '<a onclick="UYAN.loginKaixin001();" style="padding: 0; cursor: pointer; display: block; float: left; height: 23px; margin-bottom: 2px; margin-right: 3px; width: 59px; background: url(\'' + UYAN.imgHost + 'bbtn.png\') no-repeat scroll -305px 0 transparent;"></a>';
                                        break;
                                    default:
                                        b += '';
                                        break
                ...
                isMob: function() {
                    var a = ua.match(/ucweb|ios|mobile|ipad|ipod|blackberry|motorola|YahooSeeker|symbian|nokia|android|iphone os|windows ce|rv:1.2.3.4|midp/i),
                        sw = p(window.screen.width),
                        sh = p(window.screen.height),
                        ret = false;
                    if (a) {
                        UYAN.mName = a;
                        if (sw < sh) {
                ...
                changeSet: function() {
                    ...
                    if (UYAN.conf.loginuid && UYAN.conf.loginuid != 100) {
                        try {
                    ...
                    if (UYAN.conf.loginuid && UYAN.conf.uface) {
                        try {
                    ...
                    try {
                        if (UYAN.conf.isrcmd == '1' || UYAN.conf.isrcmd == '2') {
                            var c = d.createElement('div'),
                                f = d.getElementById('uyan_cmt_list');
                            ...
                            UYAN.creElm({
                                src: 'http://v1.ujian.cc/code/ujian.js?uid=' + UYAN.conf.uid + (UYAN.conf.isrcmd == '2' ? '&om=1' : ''),
                                charset: 'utf-8',
                                id: 'uyan_script'
                            }, 'script', d.getElementsByTagName('head')[0] || dd)
                        }
